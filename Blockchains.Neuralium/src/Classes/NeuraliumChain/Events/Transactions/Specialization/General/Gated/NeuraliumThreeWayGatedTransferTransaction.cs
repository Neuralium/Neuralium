...
namespace Blockchains.Neuralium.Classes.NeuraliumChain.Events.Transactions.Specialization.General.Gated {
	...
	/// <summary>
	///  a special transaction which will be gated until a verifier either aprouves it or rejects. Tokens will be frozen in sender account until it is aprouved.
	/// </summary>
	public class NeuraliumThreeWayGatedTransferTransaction : ThreeWayGatedTransaction, INeuraliumThreeWayGatedTransferTransaction {
		...
		/// <summary>
		/// the service fee given to the verifier as soon as the transaction comes into action. This is given even if the transaction times out (no action is taken) and defaults
		/// </summary>
