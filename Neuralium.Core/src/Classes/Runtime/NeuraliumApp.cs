		...
		protected virtual async Task StartChains(LockContext lockContext) {
			...
			if((this.neuraliumBlockChainInterface != null) && this.appSettings.NeuraliumChainConfiguration.Enabled) {
				try {
					...
					this.globalService.SetChainStarted(NeuraliumBlockchainTypes.NeuraliumInstance.Neuralium, true);
				} catch(Exception ex) {
		...
		protected virtual async Task StopChains(LockContext lockContext) {
			...
			if((this.neuraliumBlockChainInterface != null) && this.appSettings.NeuraliumChainConfiguration.Enabled) {
				try {
					...
					this.globalService.SetChainStarted(NeuraliumBlockchainTypes.NeuraliumInstance.Neuralium, false);
				} catch(Exception ex) {
