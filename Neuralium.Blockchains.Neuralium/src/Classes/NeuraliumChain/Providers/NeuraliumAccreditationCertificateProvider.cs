...
namespace Neuralium.Blockchains.Neuralium.Classes.NeuraliumChain.Providers {
	...
	public abstract class NeuraliumAccreditationCertificateProviderGenerix<CENTRAL_COORDINATOR, CHAIN_COMPONENT_PROVIDER, ACCREDITATION_CERTIFICATE_DAL, ACCREDITATION_CERTIFICATE_CONTEXT, ACCREDITATION_CERTIFICATE_SNAPSHOT, ACCREDITATION_CERTIFICATE_ACCOUNT_SNAPSHOT> : AccreditationCertificateProvider<CENTRAL_COORDINATOR, CHAIN_COMPONENT_PROVIDER, ACCREDITATION_CERTIFICATE_DAL, ACCREDITATION_CERTIFICATE_CONTEXT, ACCREDITATION_CERTIFICATE_SNAPSHOT, ACCREDITATION_CERTIFICATE_ACCOUNT_SNAPSHOT>, INeuraliumAccreditationCertificateProviderGenerix<CENTRAL_COORDINATOR, CHAIN_COMPONENT_PROVIDER, ACCREDITATION_CERTIFICATE_DAL, ACCREDITATION_CERTIFICATE_CONTEXT, ACCREDITATION_CERTIFICATE_SNAPSHOT, ACCREDITATION_CERTIFICATE_ACCOUNT_SNAPSHOT>
		...
		public async Task<Dictionary<AccountId, (decimal delegateBountyShare, decimal InfrastructureServiceFees)>> GetDelegateAllocationPercentages(ImmutableList<AccountId> validDelegates, Enums.CertificateApplicationTypes applicationType) {
			...
			List<ACCREDITATION_CERTIFICATE_SNAPSHOT> certificateSnapshots = await this.SnapshotProvider.GetAccreditationCertificates(validDelegates, new[] {AccreditationCertificateTypes.Instance.DELEGATE, AccreditationCertificateTypes.Instance.SDK_PROVIDER}, applicationType).ConfigureAwait(false);
			Dictionary<AccountId, (decimal delegateBountyShare, decimal InfrastructureServiceFees)> results = new Dictionary<AccountId, (decimal delegateBountyShare, decimal InfrastructureServiceFees)>();
