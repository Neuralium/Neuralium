...
namespace Neuralium.Blockchains.Neuralium.Classes.NeuraliumChain.Events.Digests.Channels.Specialization {
	...
	public interface INeuraliumModeratorAccountKeysDigestChannel : IModeratorAccountKeysDigestChannel<NeuraliumStandardAccountKeysDigestChannelCard>, INeuraliumDigestChannel {
	}

	public class NeuraliumModeratorAccountKeysDigestChannel : ModeratorAccountKeysDigestChannel<NeuraliumStandardAccountKeysDigestChannelCard>, INeuraliumModeratorAccountKeysDigestChannel {
		[Flags]
		public enum AccountKeysDigestChannelBands {
			Wallets
		}

		public NeuraliumModeratorAccountKeysDigestChannel(int groupSize, string folder) : base(groupSize, folder) {
		}
