...
namespace Neuralium.Blockchains.Neuralium.Classes.NeuraliumChain.Events.Blocks.Specialization.Elections.Results.V1 {
	public interface INeuraliumIntermediaryElectionResults : INeuraliumElectionResults, IIntermediaryElectionResults, INeuraliumIntermediaryElectionResultsimplementation {
	}
}