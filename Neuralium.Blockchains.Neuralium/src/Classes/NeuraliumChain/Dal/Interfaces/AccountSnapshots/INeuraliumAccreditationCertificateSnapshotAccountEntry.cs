...
namespace Neuralium.Blockchains.Neuralium.Classes.NeuraliumChain.Dal.Interfaces.AccountSnapshots {
	public interface INeuraliumAccreditationCertificateSnapshotAccountEntry : IAccreditationCertificateSnapshotAccountEntry, INeuraliumAccreditationCertificateSnapshotAccount {
	}
