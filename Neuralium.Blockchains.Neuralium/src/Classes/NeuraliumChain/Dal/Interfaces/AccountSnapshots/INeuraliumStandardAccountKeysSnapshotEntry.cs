...
namespace Neuralium.Blockchains.Neuralium.Classes.NeuraliumChain.Dal.Interfaces.AccountSnapshots {
	public interface INeuraliumStandardAccountKeysSnapshotEntry : INeuraliumStandardAccountKeysSnapshot, INeuraliumAccountKeysSnapshotEntry, IStandardAccountKeysSnapshotEntry {
	}
}